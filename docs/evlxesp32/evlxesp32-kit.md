# E-VLXESP32 - Kit Version

![E-VLXESP32](./img/evlxesp32_kit.png){: .center width="512"}
...
| **Parameter**           | **Details**                               |
|-------------------------|-------------------------------------------|
| Standard Input Voltage  | 5 VDC                                     |
| Power Consumption       | 50 mA                                     |
| Power Supply            | From USB-C port                           |
...
![E-VLXESP32 views](img/evlxesp32_kit_view.png){: .center}
...
The plastic enclosure of the device must be 3D print.
...
![E-VLXESP32 kit dimensions](img/evlxesp32_kit_dimension.png){: .center}

<p style="text-align: center; font-weight: bold">E-VLXESP32 kit outline (dimensions in mm).</p><br>
...
![E-VLXESP32 wiring](img/evlxesp32_kit_wiring.png){: .center}

<p style="text-align: center; font-weight: bold">E-VLXESP32 kit connect to the USB power cable</p><br>
